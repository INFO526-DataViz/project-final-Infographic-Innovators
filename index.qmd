...
flights_ntsb_maps_updated <-
  ...
  # filtering states which are officially recognized(ex: removing district of columbia)
  filter(state %in% state.name)
```

```{r hex_bin_geometry, include=FALSE}
# Adding a shapefile dataset for plotting Crashes on the US map
...
# merging data based on state names
...
# For saving the plotted Hex-Bin map in jpg format
