...
We wanted provide an in-depth analysis of aircraft crashes in the United States from 1980 to 2022, focusing on locations, timings, and consequences, along with exploring causes and weather conditions' influence on these incidents.

1.  Question: What are the locations, timings, and consequences of the aircraft crashes?

    Objective: To discover if there were any correlations that contribute to aircraft crashes during a certain time period. As well as looking to see if certain locations have higher numbers of crashes than others.
    ...
    Findings: Overall when looking at the crashes through 1980-2020 the number of total fatalitles from crashes have gone down. There was a significant jump in 2001 which we concluded was from the 9/11 attacks. After which the number of fatalies decreased significatly.
...
Total Fatalitites Over The Years
